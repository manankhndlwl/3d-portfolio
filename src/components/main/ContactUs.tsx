            ...
            >
              ...
              <div className="space-y-5 text-foreground">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">+91 9810585686</span>
                  <button
                    onClick={() => copyToClipboard('+919810585686', 'Phone number')}
                    className="text-muted-foreground hover:text-primary transition"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">Delhi, India</span>
                </div>
              </div>
            </motion.div>
